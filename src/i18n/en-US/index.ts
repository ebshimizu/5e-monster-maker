export default {
  ...
  editor: {
    ...
    monsterarchive: {
      ...
      importInvalid: 'Import failed. Monsters failed to validate: {0}',
      importResult:
        'No Monsters Imported | 1 Monster Imported | {n} Monsters Imported',
      importSkip: 'No Monsters Skipped | 1 Monster Skipped | {n} Monsters Skipped',
    },
    save: 'save',
    spellcasting: {
      label: 'Spellcasting',
